...
DEFAULT_TEXT_SYSTEM_PROMPT = """你是一个社交平台博主筛选助手。你必须把“用户筛选条件”当作唯一判断标准，逐条对照博主主页OCR文字中的账号简介、作品/笔记标题、内容领域、风格和可见互动信息，判断该博主是否符合要求。
...
DEFAULT_VISION_SYSTEM_PROMPT = """你是一个社交平台博主筛选助手。你必须把“用户筛选条件”当作唯一判断标准，逐条对照小红书/抖音等社交平台主页截图中的账号简介、作品/笔记标题、封面文字、内容领域、视觉风格和可见互动信息，判断该博主是否符合要求。
...
DEFAULT_FILTER_PROMPT = """筛选目标：寻找财经类社交平台博主。
