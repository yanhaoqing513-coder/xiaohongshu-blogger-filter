...
根据小红书或抖音博主主页链接，自动打开页面截图，并根据自定义筛选条件判断博主是否符合要求。
...
4. **开始筛选**
   ...
   - 抖音主页通常必须登录后才能查看；遇到登录提示时，请在浏览器中登录后点击“我已登录，继续运行”
...
### Q: 抖音筛选为什么提示需要登录？
A: 抖音主页通常需要登录账号后才能正常查看。系统检测到登录页或登录弹窗时会暂停任务；你在浏览器中完成抖音登录后，回到页面点击“我已登录，继续运行”即可。
